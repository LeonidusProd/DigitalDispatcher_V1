# Generated by Django 4.2.8 on 2024-02-22 16:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api_v1.employee', verbose_name='Исполнитель')),
                ('resident', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_v1.resident', verbose_name='Автор заявки')),
                ('service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api_v1.service', verbose_name='Задача')),
